...
class AddActivityController extends GetxController {
  ...
  late String id;
  AddToSubjectData addActivityData = AddToSubjectData(Crud());
  Rx<StatusRequest> statusRequest = StatusRequest.success.obs;
  GlobalKey<FormState> activityFormKey = GlobalKey<FormState>();
  ...
  void onClose() {
    ...
    //activityFormKey.currentState!.dispose();
    super.onClose();
  }
  ...
  if(activityFormKey.currentState!.validate()){
    ...
    var response = await addActivityData.getData(
        id,{
    ...
    if(StatusRequest.success == statusRequest.value){
      if(response['status']==true){
        Get.defaultDialog(title: "",middleText:"Activity Added Successfully");
