...
class AddAssignmentScreen extends StatelessWidget {
  ...
  AddAssignmentController controller = Get.put(AddAssignmentController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: GetX<AddAssignmentController>(
        builder: (controller){
          return Stack(
            fit: StackFit.expand,
            children: [
              TopWidget(type: "fixed", containedWidget: TopWidgetTitle(
                text: "addAssignment".tr,type:"withBackArrow",
              ),
              ),
              Positioned(
                          ...
                          children: [
                            Padding(
                              ...
                              child: ListView(
                                ...
                                children: [
                                  AddFieldsWidget(hintText: 'chapterOne'.tr, labelText: 'assignmentName'.tr,
                                  ...
                                  AddFieldsWidget(hintText: trialStr, labelText: 'assignmentDetails'.tr,
                                  ...
                                  SizedBox(height: 3.0.hp,),
                                  Text("deliveryDateAssignment".tr,style: TextStyle(
                                      fontSize: 12.0.sp,
                                      color: Colors.black
                                  ),),
                                  const SizedBox(height: 17.0,),
