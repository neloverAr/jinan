...
class AddAssignmentController extends GetxController {
  ...
  late String id;
  AddToSubjectData addAssignmentData = AddToSubjectData(Crud());
  ...
  addAssignment() async{
    ...
    var response = await addAssignmentData.getData(
        id,{
    ...
    if(StatusRequest.success == statusRequest.value){
      if(response['status']==true){
        Get.defaultDialog(title: "",middleText:"Assignment Added Successfully");
