...
class SubjectHomeworkDesc extends StatelessWidget {
  final SubjectHomework homework;
  SubjectHomeworkDesc({Key? key,required this.homework}) : super(key: key);
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(child: ClipRRect(borderRadius: BorderRadius.circular(5),child:
                      CachedNetworkImage(
                        imageUrl: homework.image!,height: 200, width:double.infinity,fit: BoxFit.fill,
                      ...
                      Text(homework.arName!,style: TextStyle(color: red,fontWeight: FontWeight.bold),),
                      Text(homework.arDescription!,textAlign: TextAlign.justify,style:
                      TextStyle(color: const Color(0xFF292D32).withOpacity(.9),height: 0.2.hp),),
                            ...
                            child: InkWell(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    SvgPicture.asset(getExt(homework.file!)=="pdf"?pdfIcon:getExt(homework.file!)=="docx"?wordIcon:imageIcon),
                                    SizedBox(height: 1.0.hp,),
                                    SizedBox(width: 100,child: Text(basename(homework.file!),textAlign: TextAlign.center,
